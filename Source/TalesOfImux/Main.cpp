...
void AMain::ESCDown()
{
	...
	UE_LOG(LogTemp, Warning, TEXT("FSDFSD"));
	if (MainPlayerController)
	{
		UE_LOG(LogTemp, Warning, TEXT("21321"));
...
void AMain::SaveGame()
{
	UImuxSaveGame* SaveObject = Cast<UImuxSaveGame>(UGameplayStatics::CreateSaveGameObject(UImuxSaveGame::StaticClass()));
	...
	UE_LOG(LogTemp, Warning, TEXT("SaveObject->CharacterStats.LevelName: %s"), *SaveObject->CharacterStats.WeaponName)
...
{
	UImuxSaveGame* Load = Cast<UImuxSaveGame>(UGameplayStatics::CreateSaveGameObject(UImuxSaveGame::StaticClass()));
	UImuxSaveGame* LoadObject = Cast<UImuxSaveGame>(UGameplayStatics::LoadGameFromSlot(Load->SaveSlotName, Load->UserIndex));
